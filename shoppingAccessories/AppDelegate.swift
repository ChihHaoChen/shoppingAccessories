...
//  shoppingAccessories
//
//  Created by chihhao on 2019-01-18.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = UIColor.init(red: 87/255, green: 39/255, blue: 40/255, alpha: 1)
        ...
        let categoryController = CategoryVC()
